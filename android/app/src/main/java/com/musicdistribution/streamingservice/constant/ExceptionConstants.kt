...
object ExceptionConstants {
    ...
    const val NOTIFICATION_FETCH_FAILED =
        "There was a problem when fetching the notification with id "
    const val LISTENER_DATA_FETCH_FAILED =
        "There was a problem when fetching the listener data with id "
    const val ARTIST_PICTURE_FETCH_FAILED = "There was a problem when fetching the the artist image"
    const val ALBUM_PICTURE_FETCH_FAILED =
        "There was a problem when fetching the the album cover image"
    const val SONG_PICTURE_FETCH_FAILED =
        "There was a problem when fetching the the song cover image"
