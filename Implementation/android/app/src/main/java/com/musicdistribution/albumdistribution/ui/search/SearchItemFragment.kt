...
class SearchItemFragment : Fragment(), SearchItemClickListener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        searchFragmentViewModel =
            ViewModelProvider(requireActivity())[SearchFragmentViewModel::class.java]
    ...
    private fun fillRecyclerView(): SearchItemAdapter {
        ...
        searchItemRecyclerView.layoutManager = LinearLayoutManager(requireActivity(), RecyclerView.VERTICAL, false)
