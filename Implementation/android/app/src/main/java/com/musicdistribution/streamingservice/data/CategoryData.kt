...
object CategoryData {
    ...
    val artistData: MutableList<Category> = mutableListOf(
        Category(4, MessageConstants.PUBLISHED_SONGS, mutableListOf(), CategoryItemType.PUBLISHED_SONG),
        Category(5, MessageConstants.PUBLISHED_ALBUMS, mutableListOf(), CategoryItemType.PUBLISHED_ALBUM),
    )
}