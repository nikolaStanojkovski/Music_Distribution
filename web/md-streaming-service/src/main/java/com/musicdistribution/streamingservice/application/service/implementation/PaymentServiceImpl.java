...
import com.musicdistribution.streamingservice.infrastructure.payment.PaymentProperties;
...
public class PaymentServiceImpl implements PaymentService {
    ...
    /**
     * Method used for capturing and confirming the validity of an order for a given payment.
     *
     * @param paymentId - the identifier of the payment.
     * @return a flag determining whether the payment was confirmed or not.
     */
    @Override
    public Boolean capturePayment(String paymentId) {
        try {
            ...
            return httpResponse.result().status().equalsIgnoreCase(TransactionConstants.COMPLETED_ORDER_STATUS);
        } catch (IOException e) {
            log.error(e.getMessage());
        }
        return false;
